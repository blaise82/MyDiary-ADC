...
var _entry = _interopRequireDefault(require("../../controllers/v2/entry"));

var _authenticate = _interopRequireDefault(require("../../middleware/v2/authenticate"));
...
router.post('/entries', [_authenticate["default"], _checkNewEntry["default"]], _entry["default"].add);
